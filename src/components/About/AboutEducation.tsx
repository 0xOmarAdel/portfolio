  ...
  return (
    <div className="flex flex-row gap-4">
      <div className="relative">
        ...
        <div className="absolute top-2 left-1/2 -z-10 h-[calc(100%-0.5rem)] w-[3px] bg-gradient-to-r from-violet-400 to-purple-800 rounded-bl-full rounded-br-full -translate-x-1/2"></div>
      </div>
